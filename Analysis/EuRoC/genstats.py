...
def gen_stats(seq: str, trial: str):
    ...
    file_interface.write_tum_trajectory_file("./traj_gt/{}_tum.csv".format(seq), tgt, confirm_overwrite=False)
    tgt = file_interface.read_tum_trajectory_file("./traj_gt/{}_tum.csv".format(seq))

    # experimental trajectories
    tos2 = file_interface.read_tum_trajectory_file("./traj_os2/{}/{}.txt".format(trial, seq))
    texp = file_interface.read_tum_trajectory_file("./traj_exp/{}/{}.txt".format(trial, seq))
...
for seq in ["MH01", "MH02", "MH03", "MH04", "MH05", "V101", "V102", "V103", "V201", "V202"]:
