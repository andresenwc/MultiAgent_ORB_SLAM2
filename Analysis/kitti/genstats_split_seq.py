...
def gen_stats(seq: str, trial: str):
    ...
    tos2 = file_interface.read_kitti_poses_file("./traj_os2/{}/{}.txt".format(trial, seq))
    texp = file_interface.read_kitti_poses_file("./traj_exp_split_seq/{}/{}.txt".format(trial, seq))

    # align and scale the trajectories
    tos2_as = copy.deepcopy(tos2)
    tos2_as.align(tgt, correct_scale=True)

    texp_as = copy.deepcopy(texp)
    texp_as.align(tgt, correct_scale=True)
